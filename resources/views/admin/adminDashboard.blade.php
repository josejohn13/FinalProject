...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:250px;" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button" href="booking/list">Booking List</a>
  <a class="w3-bar-item w3-button" href="destination/list">Destination List</a>
</nav>
...
<header class="w3-container w3-theme" style="padding:64px 32px">
  <h1 class="w3-xxxlarge">BeCool Travel & Tours</h1>
</header>
