...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="/booking/submit" method="post">
  <input type="hidden" name="_token" value="{{csrf_token()}}">
    <div class="container">
      <h1>Create Booking</h1>
      <hr>
      <label for="email"><b>Book Date</b></label>
      <input type="date" placeholder="" name="book_date" required>

      <label for="email"><b>Book Type</b></label>
      <input type="text" placeholder="Enter Type" name="book_type" required>

      <label for="psw"><b>Book Description</b></label>
      <input type="text" placeholder="Enter Description" name="book_description" required>
